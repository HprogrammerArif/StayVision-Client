...
const BookingMaterialsRow = ({ booking }) => {
  console.log(booking);
  return (
      ...
      <tr>
        ...
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
          <Link
            to={`view-booked-materials/${booking?.sessionId}`}
          ...
          >
            ...
            ></span>
            <span className="relative">View Resouse</span>
          </Link>
        </td>
      </tr>
...
BookingMaterialsRow.propTypes = {
  booking: PropTypes.object,
  refetch: PropTypes.func,
};

export default BookingMaterialsRow;
